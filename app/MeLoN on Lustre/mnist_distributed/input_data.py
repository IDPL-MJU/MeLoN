...
def read_data_sets(train_dir,
  ...
  train_images_file = train_dir+'/train-images-idx3-ubyte.gz'
  train_labels_file = train_dir+'/train-labels-idx1-ubyte.gz'
  test_images_file = train_dir+'/t10k-images-idx3-ubyte.gz'
  test_labels_file = train_dir+'/t10k-labels-idx1-ubyte.gz'

#  local_file = _maybe_download(train_images_file, train_dir,
#                               source_url + train_images_file)
  local_file = train_images_file
  with gfile.Open(local_file, 'rb') as f:
    train_images = _extract_images(f)

#  local_file = _maybe_download(train_labels_file, train_dir,
#                               source_url + train_labels_file)
  local_file = train_labels_file
  with gfile.Open(local_file, 'rb') as f:
